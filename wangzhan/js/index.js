window.addEventListener('load',function(){
    ...
    new Box(-1,2,'../images/6.jpg');
    new Box(0,2,'../images/7.jpg');
    new Box(1,2,'../images/8.jpg');
    new Box(2,2,'../images/4.jpg');
    new Box(3,2,'../images/5.jpg');
    new Box(4,2,'../images/9.jpg');
    new Box(5,2,'../images/10.jpg');
    new Box(2,-2,'../images/11.jpg');
    new Box(2,-1,'../images/6.jpg');
    new Box(2,0,'../images/7.jpg');
    new Box(2,1,'../images/8.jpg');
    new Box(2,2,'../images/9.jpg');
    new Box(2,3,'../images/10.jpg');
    new Box(2,4,'../images/11.jpg');
    new Box(2,5,'../images/5.jpg');
